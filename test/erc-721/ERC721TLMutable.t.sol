...
contract ERC721TLMutableTest is Test {
    using Strings for uint256;
    using Strings for address;

    ERC721TLMutable public tokenContract;
    ...
    function setUp() public {
        ...
        tokenContract = new ERC721TLMutable(false);
    ...
    function test_initialize(
        ...
        tokenContract = new ERC721TLMutable(true);
    ...
    function test_mint_customErrors() public {
        vm.expectRevert(ERC721TLMutable.EmptyTokenURI.selector);
    ...
    function test_mint(uint16 tokenId, address recipient) public {
        ...
        vm.expectRevert(ERC721TLMutable.TokenDoesntExist.selector);
    ...
    function test_batchMint_customErrors() public {
        vm.expectRevert(ERC721TLMutable.MintToZeroAddress.selector);
        tokenContract.batchMint(address(0), 2, "uri");

        vm.expectRevert(ERC721TLMutable.EmptyTokenURI.selector);
        tokenContract.batchMint(address(this), 2, "");

        vm.expectRevert(ERC721TLMutable.BatchSizeTooSmall.selector);
    ...
    function test_airdrop_customErrors() public {
        ...
        vm.expectRevert(ERC721TLMutable.AirdropTooFewAddresses.selector);
    ...
    function test_burn_accessControl(uint16 tokenId, address collector, address hacker) public {
        ...
        vm.expectRevert(ERC721TLMutable.CallerNotApprovedOrOwner.selector);
        tokenContract.burn(tokenId);
        vm.stopPrank();
    ...
    function test_mutable_metadata_customErrors() public {
        ...
        vm.startPrank(address(1), address(1));
        vm.expectRevert(ERC721TLMutable.NotOwnerAdminOrMintContract.selector);
        tokenContract.updateTokenUri(1, "uri");
        vm.stopPrank();
    }
    ...
    function test_updateTokenUri_accessControl(address user) public {
        ...
        // verify that minters can propose
        tokenContract.setRole(tokenContract.APPROVED_MINT_CONTRACT(), users, true);
        vm.startPrank(user);
        tokenContract.updateTokenUri(1, "newNewUri");
        assertEq(tokenContract.tokenURI(1), "newNewUri");
        vm.stopPrank();
        tokenContract.setRole(tokenContract.APPROVED_MINT_CONTRACT(), users, false);
    ...
    function test_story_nonExistentTokens() public {
        ...
        vm.expectRevert(ERC721TLMutable.CallerNotTokenOwnerOrDelegate.selector);
    ...
    function test_story_disabled(address collector) public {
        ...
        vm.expectRevert(ERC721TLMutable.StoryNotEnabled.selector);
        tokenContract.addStory(1, "NOT XCOPY", "I AM NOT XCOPY");
        vm.stopPrank();
    ...
    function test_blocklist_mint(address collector, address operator) public {
        ...
        tokenContract.mint(collector, "uri");
        vm.startPrank(collector, collector);
        vm.expectRevert(ERC721TLMutable.OperatorBlocked.selector);
